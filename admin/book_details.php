    ...
    ?>
                        <div class="card my-5 border-dark">
                            <div class="card-header" style="background-color: #35694a;">
                                ...
                                <a href="update_books.php?eid=<?php echo $result['id'];?>" class="px-3 pt-2 text-white">Edit</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                    <tr>
                                       <th class="p-4">Photo</th>
                                       <td class="p-4" style="max-width:500px;"><img src="<?php echo $result['cover'];?>" alt="" width="100%" height="100%"></td>
                                   </tr>
                                   <tr>
                                   ...
                                   <tr>
                                       ...
                                       <td class="p-4" colspan="3"><?php echo $result['author'];?></td>
                                   </tr>
