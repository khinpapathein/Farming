...
<html lang="en">
    ...
    $query = "select * from questions where id=:pendingid";
    $data = [
        'pendingid' => $pendingid
    ];
    ...
    ?>
                        <div class="card my-5">
                            <div class="card-body">
                            <a href="pendingPosts.php" class="pb-2" style="color: #88B44E;">back</a>
                                <table class="table table-bordered">
                                   ...
                                   <form method="post">
                                        <tr>
                                            ...
                                            <td colspan="4" style="text-align:center ;"><button type="submit" class="btn btn-primary btn-block" name="Accept">Accept</button></td>
                                        </tr>
                                    </form>
                                </table>
                            </div>
