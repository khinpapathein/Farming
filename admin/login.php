...
<html lang="en">
    ...
    <body class="" style="background: linear-gradient(rgba(136, 180, 78, .7), rgba(136, 180, 78, .7)), url(../img/video_bg1.jpg) center center no-repeat;background-size: cover;">
                            ...
                            <div class="col-lg-5 mt-3 ">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header">
                                        <!-- <h2 class="text-center">Registration and Login System</h2>
                                        <hr /> -->
