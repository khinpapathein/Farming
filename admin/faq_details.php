    ...
    ?>
                        <div class="card my-5 border-dark">
                            <div class="card-header" style="background-color: #35694a;">
                                ...
                                <a href="faq_edit.php?edit_id=<?php echo $result['id'];?>" class="px-3 pt-2 text-white">Edit</a>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered">
                                   <tr>
                                        <th class="p-4">မေးခွန်း</th>
                                       <td class="p-4"><?php echo $result['question'];?></td>
                                   </tr>
                                   <tr>
                                       <th class="p-4">အဖြေ</th>
                                       <td class="p-4" colspan="3"><?php echo $result['answer'];?></td>
                                   </tr>
                                </table>
                            </div>
                        </div>
