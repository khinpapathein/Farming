<?php 
    ...
    if(isset($_POST['update'])){
        ...
        if($status == 0){
            ...
            $sql3 = "update paddy_type set paddy_id=:pid,type_id=:typeid where id=:id";
            $data3 = [
                'pid' => $newpid,
                'typeid' => $typeid,
                'id' => $id
                            ...
                            <div class="card-body">
                                <form method="post" class="form-horizontal" name="addPost" class="form-horizontal"  enctype="multipart/form-data">
                                    <div class="row form-group py-2 py-md-3">
                                        ...
                                        <div class="col-sm-7">
                                        <input type="text" name="name" id="name" class="form-control" value="<?php echo $data1['name'];?>" required>
                                        </div>
                                    </div>
                                    <div class="row form-group py-2 py-md-3">
