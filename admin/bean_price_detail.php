...
<html lang="en">
    ...
    <?php 
        $id=$_GET['id'];
        $query = "select * from bean_price where id=:id";
        $data = [
            'id' => $id
        ];
        ...
        // for bean name
        $bid = $result['bean_id'];
        $sql1 = "select * from beans_type where id=:bid";
        $inputData1 = [
            'bid' => $bid
        ];
    ...
    ?>
                        <div class="card my-5 border-dark">
                            <div class="card-header" style="background-color: #35694a;">
                                ...
                                <a href="bean_price_edit.php?edit_bid=<?php echo $result['id'];?>" class="px-3 pt-2 text-white">Edit</a>
                            </div>
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <th class="p-4" style="width : 200px;">စေ◌ျးနှုန်း</th>
