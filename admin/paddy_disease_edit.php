<?php 
    ...
    if(isset($_POST['update'])){
        ...
        if($type == 'ရောဂါ'){
            ...
            $sql = "update paddy_diseases set name=:name,type=:type, infection=:infection, characteristics=:characteristics, cause_time=:cause_time, prevention=:prevention where id=:id";
            $data = [
                'name' => $name,
                'type' => $type,
                'infection' => $infection,
            ...
            $sql = "update paddy_diseases set name=:name,type=:type, infection=:infection, characteristics=:characteristics, prevention=:prevention where id=:id";
            $data = [
                'name' => $name,
                'type' => $type,
                'infection' => $infection,
...
<html lang="en">
    ...
    <?php 
    $disease_id=$_GET['edit_did'];
    $query = "select * from paddy_diseases where id=:disease_id";
    $data = [
