<?php 
    ...
    if(isset($_GET['did'])){
        $id= $_GET['did'];
        $sql = "update paddy_diseases set status=:status where id=:id";
        $status = "Delete";
        $data = [
            'status' => $status,
            'id' => $id
            ...
            <div id="layoutSidenav_content">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Diseases & Pests For Paddy</h1>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item active">Diseases & Pests For Paddy</li>
                        </ol>

                        <div class="d-flex justify-content-end mb-3 mx-3">
                            <button class="btn btn-success fw-bold py-2" type="button">
                                <a href="AddD&P.php" class="text-decoration-none text-white">Add</a>
                            </button>
                        </div>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Diseases & Pests' Details
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple" class="table-hover">
                                    ...
                                    <tbody>
                        <?php 
                            $sql = "select * from paddy_diseases where status='Active'";
                            $result = $conn->prepare($sql);
                            $result->execute();
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="diseases_details.php?disease_id=<?php echo $row['id'];?>" class="px-1 text-decoration-none">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="paddy_diseases.php?did=<?php echo $row['id'];?>" onClick="return confirm('Are you sure to delete');">
