<?php 
    ...
    if(isset($_GET['bid'])){
        $id= $_GET['bid'];
        $sql = "delete from bean_price where id=:id";
        $data = [
            'id' => $id
        ];
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="d-flex justify-content-end mb-3 mx-3">
                            <button class="btn btn-success fw-bold py-2" type="button">
                                <a href="add_bean_price.php" class="text-decoration-none text-white">Add</a>
                            </button>
                        </div>
                        <div class="card mb-4">
                        ...
                        <?php 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="bean_price_detail.php?id=<?php echo $output['id'];?>" class="px-1 text-decoration-none">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="bean_price.php?bid=<?php echo $output['id'];?>" onClick="return confirm('Are you sure to delete');">
