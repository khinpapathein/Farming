            ...
            <div class="row">
                <div class="col-12 col-md-4 col-lg-3 mypf">
                    ...
                    <div class="mt-md-5 mx-md-2 mynav">
                        ...
                        <hr class="my-2"><a href="myAcc_pending.php" class="fw-bold">တောင်းဆိုထားသောပို့စ်များ <span style="font-size: 15pt; font-weight: 600; color: red;"><?php echo $count_pending;?></span> ခု</a>
                ...
                <div class="col-12 col-md-7 col-lg-8 rightSide">
                    
        <?php 
            $id= 2;
            $status = "Pending";
            $userid = $_SESSION['userId'];
            $sql="select * from questions where status=:status && user_id=:userid";
            $inputdata = [
                'status' => $status,
                'userid' => $userid
            ];
            ...
            if($result->rowCount()){
                ?>
                <h3 class="mb-3 mb-md-4 noPosts">တောင်းဆိုထားသောပို့စ်များ</h3>
                <?php
            ...
            <?php
                foreach($data as $row){
            ?>  
                        <div class="row mydiv px-2 py-2" onclick="document.getElementById('<?php echo $row['id'];?>').style.display='block'">
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="btn btn-danger" class="mybtn m-3"><a href="myAcc_pending.php?deleteId=<?php echo $row['id'];?>" onClick="return confirm('Are you sure to delete');">Delete</a></button>
                            </div>
                        </div>
            ...
            ?>
                <h3 class="px-2 px-md-5 noPosts text-danger">တောင်းဆိုထားသောပို့စ် မရှိပါ။</h3>
            <?php
            }
            ?>           
